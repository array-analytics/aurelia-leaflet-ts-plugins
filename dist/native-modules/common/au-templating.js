...
import { ViewLocator, ViewEngine } from "aurelia-templating";
...
var Templating = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, viewStrategy.loadViewFactory(Templating.viewEngine, new ViewCompileInstruction())];
                    case 1:
                        viewFactory = _a.sent();
    ...
    Templating.makeDomElement = function (content, model) {
        ...
        if (content instanceof HTMLElement)
            ...
            var contentElement = DomUtil.create("div");
    ...
    Templating.viewLocator = Container.instance.get(ViewLocator);
    Templating.viewEngine = Container.instance.get(ViewEngine);
    return Templating;
}());
export { Templating };
