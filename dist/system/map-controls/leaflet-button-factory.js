System.register(["aurelia-framework", "leaflet", "./../common/au-templating", "../map-controls/generic-button/leaflet-button"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, leaflet_1, au_templating_1, leaflet_button_1, LeafletButtonFactory;
    return {
        setters: [
        ...
        execute: function () {
            LeafletButtonFactory = /** @class */ (function () {
            ...
            exports_1("LeafletButtonFactory", LeafletButtonFactory);
        }
    };
});
